# Angular Boot Camp example: ngrx-store-immutability
...
**[StackBlitz for ngrx-store-immutability](https://stackblitz.io/github/AngularBootCamp/ngrx-store-immutability)**

Alternatively, you can clone the repository locally to run the example:

```
git clone git@github.com:AngularBootCamp/ngrx-store-immutability.git
cd ngrx-store-immutability
npm install
npm start
```
